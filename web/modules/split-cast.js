// ===== START OF FILE: webphy/web/modules/split-cast.js ===== //
...
export class SplitCastModule {
  ...
  applySplit(inputTex, outputFB, params, canvasW, canvasH) {
    ...
    gl.uniform1f(
      gl.getUniformLocation(this.splitProgram, "uSh"),
      params.shadowCool,
    );
    gl.uniform1f(
      gl.getUniformLocation(this.splitProgram, "uHi"),
      params.highlightWarm,
    );
  ...
  applyCast(inputTex, outputFB, params, canvasW, canvasH) {
    ...
    gl.uniform1f(
      gl.getUniformLocation(this.castProgram, "uGS"),
      params.greenShadows,
    );
    gl.uniform1f(
      gl.getUniformLocation(this.castProgram, "uMM"),
      params.magentaMids,
    );
...
// ===== END OF FILE: webphy/web/modules/split-cast.js ===== //
