// ===== START OF FILE: webphy/web/modules/motion-blur.js ===== //
// Motion Blur Module
...
export const MOTION_BLUR_PARAMS = {
  ...
  shake: { min: 0, max: 1, step: 0.01, default: 0.0, label: "Shake" },
  motionAngle: {
    min: 0,
    max: 180,
    step: 1,
...
export class MotionBlurModule {
  ...
  createProgram() {
    ...
    if (!gl.getProgramParameter(program, gl.LINK_STATUS)) {
      console.error(
        "Motion blur program link error:",
  ...
  apply(inputTex, outputFB, params, pxX, pxY, canvasW, canvasH) {
    ...
    gl.uniform1f(
      gl.getUniformLocation(this.program, "uAng"),
...
// ===== END OF FILE: webphy/web/modules/motion-blur.js ===== //
