...
mod tests {
    ...
    #[test]
    fn test_select_format_preferred() {
        let formats = vec![
            vk::SurfaceFormatKHR {
    ...
    #[test]
    fn test_select_format_fallback() {
    ...
    fn test_resolve_image_count() {
        ...
        let caps_limited = vk::SurfaceCapabilitiesKHR {
            min_image_count: 2,
            max_image_count: 2,
            ..Default::default()
        };
        assert_eq!(resolve_image_count(caps_limited), 2);
    }
}